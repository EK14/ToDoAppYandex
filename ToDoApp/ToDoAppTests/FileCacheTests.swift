...
final class FileCacheTests: XCTestCase {
    ...
    func testSaveFunction() {
        cache.addTask(ToDoItem(id: "1", text: "text", importance: .important, done: true, createdAt: Date(timeIntervalSince1970: 86400)))
        cache.addTask(ToDoItem(id: "2", text: "text", importance: .basic, done: true, createdAt: Date(timeIntervalSince1970: 86400)))
        cache.save()
    }
